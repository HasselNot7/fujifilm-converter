...
_TABLE: Dict[str, Dict[str, str]] = {
    "zh": {
        ...
        "opt_output": "输出到指定目录",
        "opt_output_desc": "转换出的 DNG 将保存到该目录（仅影响 RAW 转换）",
        "btn_browse": "浏览…",
        "dlg_output_dir": "选择输出目录",
        "hint_drop": "可直接拖入照片或文件夹",
        "st_pending": "待处理",
        "st_processing": "转换中",
        "st_success": "成功",
        "st_failed": "失败",
        "btn_retry": "重试",
        "msg_convert_summary": "完成：成功 {ok} 个，失败 {fail} 个",
        "warn_busy": "请等待当前任务完成。",
        "log_retry": "重试：{path}",
        # convert page
        "convert_title": "照片转换",
    ...
    "en": {
        ...
        "opt_output": "Output to Folder",
        "opt_output_desc": "Converted DNGs are saved to this folder (RAW conversion only)",
        "btn_browse": "Browse…",
        "dlg_output_dir": "Select Output Folder",
        "hint_drop": "Drag & drop photos or folders here",
        "st_pending": "Pending",
        "st_processing": "Processing",
        "st_success": "OK",
        "st_failed": "Failed",
        "btn_retry": "Retry",
        "msg_convert_summary": "Done: {ok} succeeded, {fail} failed",
        "warn_busy": "Wait for the current task to finish.",
        "log_retry": "Retrying: {path}",
